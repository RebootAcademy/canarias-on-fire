...
const formattedDate = computed(() => {
  if (eventStore.eventType === 'event') {
    return eventStore.eventEndDate
      ? formatEventDate(eventStore.eventDate) +
          ' - ' +
          formatEventDate(eventStore.eventEndDate)
      : formatEventDate(eventStore.eventDate)
  } else {
    return `${formatEventDate(
      eventStore.eventDate.start
    )} - ${formatEventDate(eventStore.eventDate.end)}`
  }
})
</script>
