...
export const useEventStore = defineStore('eventStore', {
  ...
  actions: {
    ...
    async saveEvent(isNew = true) {
      const eventData = this.getEventData(isNew)
    ...
    getEventData(isNew = true) {
      return {
        ...
        status: this.status,
        userId: isNew ? this.userId : this.event.userId._id,
        payment: isNew ? this.payment : this.event.payment._id,
